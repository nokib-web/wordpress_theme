    ...
    <section class="gallery-section" id="gallery">
        <div class="gallery-container">
            <div class="gallery-content">
                ...
                <h2 class="gallery-title">GIVE YOUR<br>TASTE BUDS A<br>ROLLER<br>COASTER RIDE!</h2>
                <p class="gallery-text">Are you looking for exotic and tasty food?<br>Would you like to challenge yourself with a<br>rollercoaster ride for your taste buds?</p>
                <p class="gallery-text">Then Lamfuz is for you!</p>
                <p class="gallery-text">At lamfuz we are passionate about<br>cooking inspired by the explosion of<br>flavors that Nepalese cuisine offers. We<br>offer DINE IN, takeout and catering for<br>those of you who long for exotic food and<br>new flavors - in a healthy way and without<br>emptying your wallet!</p>
            ...
            <div class="gallery-images">
                <img src="https://via.placeholder.com/400x600/c7a584/ffffff?text=Gallery+Image+1" alt="Gallery Image 1" class="gallery-img">
                <img src="https://via.placeholder.com/400x600/c7a584/ffffff?text=Gallery+Image+2" alt="Gallery Image 2" class="gallery-img">
                <img src="https://via.placeholder.com/400x600/c7a584/ffffff?text=Gallery+Image+3" alt="Gallery Image 3" class="gallery-img">
                <img src="https://via.placeholder.com/400x600/c7a584/ffffff?text=Gallery+Image+4" alt="Gallery Image 4" class="gallery-img">
            </div>
        </div>
    </section>
